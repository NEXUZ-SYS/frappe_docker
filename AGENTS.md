...
## Repository map
- `CODE_OF_CONDUCT.md/` — explain what lives here and when agents should edit it.
...
- `devcontainer-example/` — explain what lives here and when agents should edit it.
- `development/` — explain what lives here and when agents should edit it.
- `docker-bake.hcl/` — explain what lives here and when agents should edit it.
- `docs/` — explain what lives here and when agents should edit it.
- `example.env/` — explain what lives here and when agents should edit it.
